...
bathroomImg = loadImage("iamges/Bathroom.png");
nada = loadSound("images/Nada.mp3");
whyBuy = loadSound("images/whyBuy.mp3");
...
hand = createSprite(200 , 185);
hand.addImage(handImg)
hand.scale = 0.1;
hand.visible= false;

p1 = createSprite(450, 400);
p1.addImage(p1Img);
p1.scale = 0.5;
p1.visible = false;

p2 = createSprite(450, 400);
p2.addImage(p1Img);
p2.scale = 0.5;
p2.visible = false;

p3 = createSprite(450, 400);
p3.addImage(p3Img);
p3.scale = 0.5;
p3.visible = false;

p4 = createSprite(450, 400);
p4.addImage(p4Img);
p4.scale = 0.5;
p4.visible = false;

p5 = createSprite(450, 400);
p5.addImage(p5Img);
p5.scale = 0.5;
p5.visible = false;

p6 = createSprite(450, 400);
p6.addImage(p6Img);
p6.scale = 0.5;
p6.visible = false;

pCorrect = createSprite(450, 400);
pCorrect.addImage(pCorrect1Img);
pCorrect.scale = 0.5;
pCorrect.visible = false;

bathroom = createSprite(450, 400);
bathroom.addImage(bathroomImg);
bathroom.scale = 0.5;
bathroom.visible = false;

hangP = createSprite(250 , 200);
hangP.shapeColor = "black";
hangP.visible = false;
